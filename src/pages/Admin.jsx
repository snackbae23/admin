        ...
        <div className='w-full h-fit bg-[rgba(246,248,255,1)]'>
            ...
            <div className='w-full flex flex-col items-center'>
                ...
                <div className='flex justify-between w-[80%] mt-9 font-bold text-[1.3rem]'>
                    ...
                    <Link to='/alltnx' onClick={scrollToTop}><button>View all</button></Link>
                ...
                <div className='w-[80%] h-[415px] overflow-hidden p-6 bg-white mt-9 rounded-md  shadow-md '>
                    ...
                    <div className='text-[#6B7280] flex w-full justify-between mb-4 border-b-2 font-bold' >
                        <div className='w-[29%] mb-4'>
                            <div className='flex text-center items-center'>Customer Name TRx ID </div>
                        </div>
                        ...
                        {data1.map((item, index) => (
                            <div key={index} className='w-full flex my-2' >
                                ...
                                <div className='grid grid-cols-6 w-[80%]  ml-12 gap-  '>
                                    ...
                                    <Link to='/merchant' onClick={scrollToTop} className=' flex flex-col items-center ml-7 '>
                ...
                <div className='flex flex-col w-[80%] h-[500px]  mt-9 '>
                    ...
                    <div className='w-full px-4 bg-white mt-6 rounded-t  py-4 text-[1.1rem] flex justify-between font-semibold'>
                        <p className="w-[35%] flex justify-start ml-4 ">Brand Name</p>
                        <div className='flex justify-between w-[65%] '>
                            <p className="ml-14">Email</p>
                            <p className="ml-16">Customer Number</p>
                            <p className="mr-5">Date Requested</p>
                        </div>
                    ...
                    <div className='w-full h-[450px] bg-white p-4   rounded-xl overflow-y-scroll '>
                        ...
                        {data.map((reservation, index) => (
                            <div className='w-full px-4  py-2 text-[1rem] flex justify-between border-b-2' key={index}>
                                <p className="w-[35%] flex justify-start ">{reservation.BrandName}</p>
                                <div className='flex justify-between w-[65%]'>
                                    <p className="">{reservation.Email}</p>
                                    <p className="">{reservation.ContectNumber}</p>
                                    <p className="">{reservation.DateRequested}</p>
                                </div>
                ...
                <div className='flex flex-col w-[80%] h-fit  mt-9 '>
                    ...
                    <div className='bg-white w-full h-fit p-4  mb-9 rounded-lg'>
                        ...
                        <div className='w-full h-fit '>
                            ...
                            {slicedData.map((item, index) => (
                                <div key={index} className='flex justify-between text-[1.1rem] text-[#111827] px-14 border-b-2 pb-2 items-center'>
                                    <Link to='/merchant' onClick={scrollToTop} className=' flex flex-col justify-center'>
                                        <p className='text-black font-semibold text-[1.1rem]'> {item['Merchant Name']}</p>
                                        <p className='text-[#718096] text-[.9rem] font-semibold'>{item.ida}</p>
                                    </Link>

                                    <p>{item['Authorised Mail']}</p>
                                    <p className='mr-4'>{item['Created Day']}</p>
                                    <p className={`rounded-md py-1   px-2  text-center mt-2 flex items-center justify-center 
                                            ${item.Plans === 'paid' ? 'bg-[#DEF7EC] text-[#0CAF60] ' :
                                            item.Plans === 'pai' ? 'bg-[#E1EFFE] text-[#7157f1]' :
                                                item.Plans === 'new' ? 'bg-[#FBD5D5] text-red-800' : ''
                                        }`}
                                    >{item.Plans}</p>
                                    {/* <p>{item.Plans}</p> */}
                                </div>
                        ...
                        <div className='flex justify-between mt-9 w-full'>
                            ...
                            <div className='w-[50%]' >Showing {slicedData.length} out of {data2.length} results.</div>
                            <div>
                ...
                <div className='flex flex-col w-[80%] h-fit  m-7 '>
                    ...
                    <div className='flex w-full h-[400px] gap-4'>
                        ...
                        <div className='w-[50%] bg-white p-4 h-full rounded-xl overflow-y-scroll'>
                            <p className='font-bold text-[1.2rem] ml-4 mb-3 '>Latest Payout Request</p>
                            <div className='w-full h-full  '>


                                {ldata.map((item, index) => (
                                    <div key={index} className='flex justify-between text-[1.1rem] text-[#111827] px-14 font-semibold border-b-2 pb-2 items-center'>
                                        <div className=' flex flex-col justify-center'>
                                            <p className='text-black font-semibold text-[1.1rem]'> {item['res name']}</p>
                                            <p className='text-[#718096] text-[.9rem] font-semibold'>{item.resid}</p>
                                        </div>
                        ...
                        <div className='w-[50%] bg-white p-4 h-full rounded-xl overflow-y-scroll'>
                            <div className='flex justify-between'>
                                <p className='font-bold text-[1.2rem] ml-4 mb-3 '>Latest Payouts </p>
                ...
                <div className='flex flex-col w-[80%] h-fit  mb-7 '>
                    ...
                    <p className='text-[#004AAD] underline mb-5'>{pdata.length} Paid Merchant</p>
                ...
                <div className='flex flex-col w-[80%] h-[450px]  mt-9 bg-white rounded-lg p-6 mb-7'>
                    <div className='flex justify-between border-b-2 p-3'>
                        ...
                        <Link to='/blogs' onClick={scrollToTop}>
                            <button className='text-white bg-yellow-400 px-6 py-2 rounded-md'>Add Blog</button>
